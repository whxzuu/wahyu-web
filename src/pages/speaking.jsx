...
export default function Speaking() {
  return (
    <>
      <Head>
        <title>Speaking - Wahyu Budi Prayogo</title>
        <meta
          name="description"
          content="If you are looking for your next guest speaker, I'm your boy!"
        />
      </Head>
      <SimpleLayout
        title="I love to share the joy of STEM+C"
        intro="If you are looking for your next guest speaker, I'm your boy! I am passionate about women in STEM+C, living life for the adventure, and navigating college as a non-traditional student."
      >
        <div className="space-y-20">
          <SpeakingSection title="Texas State University">
            ...
            <Appearance
              ...
              description="Event with nearly 500 K-12 students, illuminating hidden truths about women and boys of color in STEM+C professions."
